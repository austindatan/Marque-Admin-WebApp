                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        ...
                                        >
                                            {logoPreview ? (
                                                <img src={logoPreview} alt="Logo Preview" className="h-20 w-20 object-contain mb-3 rounded-md shadow-sm" />
                                            ) : (
                                            ...
                                            <span className="text-xs text-muted-foreground mt-1">SVG, PNG, JPG or GIF</span>
                                            <input
                                                type="file"
                                                ref={fileInputRef}
                                                className="hidden"
